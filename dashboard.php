          ...
          foreach($today_orders as $order)
          {
            ...
            ?>
                ...
                <tr>
                    ...
                    <td><?php echo $order->delivery_time_to; ?></td>
                    <td><?php echo $order->total_net_amt; ?></td>
                    <td><?php echo $order->last_name.' '.$order->first_name; ?></td>
                    <td><?php echo $order1->product_name; ?>/<?php echo $order1->qty; ?></td>
                    <td><?php 
                    if($order->status == 0){
...
<script src="//cdn.datatables.net/buttons/1.2.1/js/buttons.html5.min.js"></script>
    ...
    $('.data_table').DataTable( {
     ...
     // alert(id_name[1].search("categories"));
      if(id_name[1].search("dashboard")!='-1')
      {
