...
<html>
 ...
 <a class="pull-right" href="<?php echo site_url("MargAPI/get_product"); ?>"><?php echo " Synch";?></a> 
                                </div><!-- /.box-header -->
                                    ...
                                    <table id="example1" class="table table-bordered table-striped">
                                        <thead>
                                            <tr>
                                                ...
                                                <th><?php echo $this->lang->line("Surfcity Prices");?></th>
                                                <th><?php echo $this->lang->line("Subscription Prices");?></th>
                                                <th><?php echo "HSN";?></th>
                                                <th><?php echo $this->lang->line("Status");?></th>
                                                
                                                <th style="width: 400px;"><?php echo $this->lang->line("Action");?></th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                           <?php if(!empty($products)){
                                              ...
                                              <tr>
                                                  ...
                                                  <td><?php if($product->shop_id!=0)
                                                  {
                                                    echo _get_name_shops($product->shop_id);  
                                                  }else{
                                                      echo "Inventory";
                                                  }
                                              ...
                                              -->    <td>
                                                  ...
                                                  <td><?php echo $product->surfcity_price; ?></td>
                                                  <td><?php echo $product->subscription_price; ?></td>
                                                  ...
                                                  <td class="text-center"><div class="btn-group">
                                                          <?php echo anchor('admin/edit_products/'.$product->product_id, '<i class="fa fa-edit" style="font-size:10px;padding:0px 1px;"></i>', array("class"=>"btn btn-success")); ?>
                                                          <?php echo anchor('admin/delete_product/'.$product->product_id, '<i class="fa fa-times" style="font-size:10px;padding:0px 1px;"></i>', array("class"=>"btn btn-danger", "onclick"=>"return confirm('Are you sure delete?')","style"=>"width: 65%;")); ?>
    ...
    <script>
     ...
     // alert(id_name[1].search("categories"));
      if(id_name[1].search("products")!='-1')
      {
