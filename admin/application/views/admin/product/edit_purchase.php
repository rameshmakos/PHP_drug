                                ...
                                <form action="" method="post" enctype="multipart/form-data">
                                    <div class="box-body">
                                        <div class="form-group">
                                         ...
                                         <input type="text"  class="form-control" name="total_price" id="total_price" value="<?php echo $purchase->total_price; ?>" readonly/>
                                         </div>     
                                         <div class="form-group">
                                            <label class="">Per KG or NOS <?php echo $this->lang->line("Price :");?> <span class="text-danger">*</span></label>
                                            <input type="number" name="price" class="form-control" value="" placeholder="00.00" min="1" required/>
                                        </div>
                                        <div class="form-group">
                                            <input type="hidden" name="prev_qty" id="prev_qty" value="<?php echo $purchase->qty; ?>" />
                                            <label class=""><?php echo $this->lang->line("Qty :");?> <span class="text-danger">*</span> (Qty must be in KG or NOS) 1000gram = 1 KG</label>
                                            <input type="number" name="qty" class="form-control" value=""  placeholder="00" min="1" required/>
                                        </div>
                                        <div class="form-group">
                                            <label class=""><?php echo $this->lang->line("Unit :");?> <span class="text-danger">*</span></label>
                                            <input type="unit" name="unit" value="<?php echo $purchase->unit; ?>" class="form-control" placeholder="KG/ BAG/ NOS/ QTY / etc" readonly/>
                                    ...
                                    <div class="box-footer">
                                        <input type="submit" class="btn btn-primary" name="addcatg" value="Edit Stock" />
                                         <a href="<?php echo site_url("admin/add_purchase"); ?>" class="btn btn-danger">Cancel</a>
