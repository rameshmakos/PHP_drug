...
<html>
  <head>
    ...
    <!-- Font Awesome -->
    <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/font-awesome/4.4.0/css/fonPurchaset-awesome.min.css">
    <!-- Ionicons -->
      ...
      <div class="content-wrapper">
                <!-- Content Header (Page header) -->
                 <section class="content-header">
                    <h1>
                         <?php echo $this->lang->line("Stock Update");?>
                                        ...
                                        <tbody>
                                           <?php foreach($purchases as $purchase){ ?>
                                            <tr>
                                                ...
                                                <td><?php 
                                                if(0<$purchase->total_price && 0< $purchase->qty)
                                                {
                                                    echo number_format($purchase->total_price/$purchase->qty,2);
                                                }
                                                 ?></td>
