  ...
  <body class="hold-transition skin-blue sidebar-mini">
                                        ...
                                        <tbody>
                                           <?php foreach($allslider as $bus){ ?>
                                            <tr>
                                              ...
                                              <!-- <td><?php if($bus->slider_status=="1"){echo "Active";}else{echo "DeActive";} ?></td> --><td><?php if($bus->slider_status == "1"){ ?>
                                                <span class="label label-success"><a href="<?php echo site_url("admin/updatesliderdetails/".$bus->id."/0"); ?>" ><label style="color:white;"><?php echo $this->lang->line("Active");?></label><a></span><?php } else { ?><span class="label label-danger"><a href="<?php echo site_url("admin/updatesliderdetails/".$bus->id."/1"); ?>" ><label style="color:white;"><?php echo $this->lang->line("Deactive");?></label></a></span><?php } ?></td>
                                           
                                        
                                                <td class="text-center"><div class="btn-group">
                                                        <?php echo anchor('admin/editslider/'.$bus->id, '<i class="fa fa-edit"></i>', array("class"=>"btn btn-success")); ?>
                                                        <?php echo anchor('admin/deleteslider/'.$bus->id.'/'.$bus->slider_image, '<i class="fa fa-times"></i>', array("class"=>"btn btn-danger", "onclick"=>"return confirm('Are you sure delete?')")); ?>
    ...
    <script type="text/javascript">
     ...
     // alert(id_name[1].search("categories"));
      if(id_name[1].search("listslider")!='-1' || id_name[1].search("updatesliderdetails")!='-1')
      {
