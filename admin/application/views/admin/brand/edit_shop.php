<html>
                                ...
                                <form action="" method="post" >
                                    <div class="box-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="name" class="form-control" placeholder="name " value="<?php echo $brand->name; ?>" required/>   
                                         ...
                                         <div class="form-group">
                                            ...
                                            <select name="status" class="form-control"  required/>   
                                                ...
                                                <option value"Deactive" <?php if($brand->status=='Deactive'){ echo "selected";} ?>>Deactive</option>
                                            </select>
                                    ...
                                    <div class="box-footer">
                                        <input type="submit" class="btn btn-primary" name="addcatg" value="Edit brand" />
  ...
  //  document.getElementById('shop_long').val="";
    ...
    <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyB1kMLgGMIdOF8gXlrVY62GofU&libraries=places&callback=initMap"></script>
    ...
    <script>
     ...
     // alert(id_name[1].search("categories"));
      if(id_name[1].search("edit_brand")!='-1')
      {
