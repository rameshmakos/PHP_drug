          ...
          foreach($today_orders as $order)
          {
            ?>
                ...
                <tr>
                    ...
                    <td><?php echo $order->on_date.'<br>'.""."".$order->delivery_time_to ; ?></td>
                    <td><?php echo $order->total_net_amt; ?></td>
                ...
                <?php }?>
                    ...
                    <td>
                        ...
                        <a href="#" id="pop" onclick="openImage('<?php echo $this->config->item('base_url').'uploads/signature/'.$order->signature; ?>')">
                            <img id="imageresource" width="50%" height="15%" src="<?php echo $this->config->item('base_url').'uploads/signature/'.$order->signature; ?>" />
                        </a>
