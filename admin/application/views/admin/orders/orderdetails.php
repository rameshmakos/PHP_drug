                        ...
                        <div class="col-md-12">
                            ...
                            <table id="" class="table table-bordered data_table">
                                ...
                                <tr>
                                    ...
                                    <th> <?php echo "CGST";?> <?php echo $this->config->item("currency");?></th>
                                    <th> <?php echo "SGST";?> <?php echo $this->config->item("currency");?></th>
                                </tr>
                                <?php
                                $total_GST=0;
                                /*
                                ...
                                */
                                ...
                                foreach($order_items2 as $items){
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <?php echo $items->CGST ; 
                                                $total_GST=$total_GST+$items->CGST ;
                                            ?>
                                        </td>
                                        <td>
                                            <?php echo $items->SGST ; 
                                            $total_GST=$total_GST+$items->SGST ;
                                            ?>
                                        </td>
                                ...
                                <tr>
                                    <td colspan="4"><strong class="pull-right"> <?php echo "Total GST:";?></strong></td>
                                    <td >
                                        <strong class=""><?php echo $total_GST; ?>  <?php echo $this->config->item("currency");?></strong>
                                    </td>
                                </tr>
                                
                                <tr>
                                    <td colspan="4"><strong class="pull-right"> <?php echo $this->lang->line("Total :");?></strong></td>
                                    <td >
                                ...
                                { ?>
                                  <tr>
                                    <td colspan="4"><strong class="pull-right"> <?php echo "Wallet Amount :"?></strong></td>
                                    <td >
                                ...
                                { ?>
                                <tr>
                                    <td colspan="4"><strong class="pull-right"> <?php echo "Coupon Amount :"?></strong></td>
                                    <td >
...
<tr>
                                    <td colspan="4"><strong class="pull-right">Discount Amount :</strong></td>
                                    <td >
                                        <strong class=""><?php echo (($order->total_net_amt)/100)*1; ?><?php echo $this->config->item("currency");?> </strong>
                                    </td>
                                </tr><?php } ?>
                                <tr>
