...
<html>
  <head>
    ...
    <title>Admin | Edit deal of product</title>
  ...
  <body class="hold-transition skin-blue sidebar-mini">
                                    ...
                                    <div class="box-body">
                                        <div class="form-group">
                                            <label class=""><?php echo $this->lang->line("Product Title :");?> <span class="text-danger">*</span></label> 
                                                    <!-- <input type="text" id="id" name="prod_title" value="<?= $product->product_name;?>" class="form-control" placeholder="Product Title"/> 
                                                     <div class="well" id="result" style="display:none;"></div>  -->  
                                                      <select name="prod_title" id="prod_title" class="form-control">
                                                         ...
                                                         <?php
                                                            ...
                                                            foreach($all_products as $all_product)
                                                            {
                                                                ...
                                                                if('"'.$all_product->unit_value.'-'.$all_product->unit.'"'=='"'.$product->deal_unit_value."-".$product->deal_unit.'"')
                                                                    $option.="<option value=".$all_product->unit_value.'-'.$all_product->unit1." selected>".$all_product->unit_value.'-'.$all_product->unit."</option>";
                                                                else
                                                                    $option.="<option value=".$all_product->unit_value.'-'.$all_product->unit1.">".$all_product->unit_value.'-'.$all_product->unit."</option>";
                                                                
                                                                if('"'.$all_product->unit_value1.'-'.$all_product->unit1.'"'=='"'.$product->deal_unit_value."-".$product->deal_unit.'"')
                                                                    $option.="<option value=".$all_product->unit_value1.'-'.$all_product->unit1." selected>".$all_product->unit_value1.'-'.$all_product->unit1."</option>";
                                                                else
                                                                    $option.="<option value=".$all_product->unit_value1.'-'.$all_product->unit1.">".$all_product->unit_value1.'-'.$all_product->unit1."</option>";
                                                                
                                                                if('"'.$all_product->unit_value2.'-'.$all_product->unit2.'"'=='"'.$product->deal_unit_value."-".$product->deal_unit.'"')
                                                                    $option.="<option value=".$all_product->unit_value2.'-'.$all_product->unit2." selected>".$all_product->unit_value2.'-'.$all_product->unit2."</option>";
                                                                else
                                                                    $option.="<option value=".$all_product->unit_value2.'-'.$all_product->unit2.">".$all_product->unit_value2.'-'.$all_product->unit2."</option>";
                                                                 
                                                                 ?>
                                                                
                                                                
                                                                     
                                                                 <option  selected value="<?php echo $all_product->product_id.','.$all_product->product_name; ?>"
                                        ...
                                        <div class="form-group">
                                            <label><?php echo $this->lang->line("dealprice");?> </label>
                                             <input type="text"  name="deal_price" class="form-control" value="<?= $product->deal_price;?>" placeholder="Deal Price"/> 
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="time" name="start_time" value="<?= $product->start_time;?>" class="form-control" placeholder="00.00"/>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="time" name="end_time" class="form-control"  value="<?= $product->end_time;?>" placeholder="00"/>
                                        </div>
                                        
                                        <div class="form-group">
                                            <label class="">Max Qty : <span class="text-danger">*</span></label>
                                            <input type="number" min="1" name="max_qty" class="form-control"  placeholder="00" value="<?= $product->max_qty;?>"/>
                                        </div>
    ...
    <script type="text/javascript">
     ...
     // alert(id_name[1].search("categories"));
      if(id_name[1].search("edit_deal_product")!='-1')
      {
