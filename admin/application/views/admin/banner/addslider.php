...
<html>
  ...
  <body class="hold-transition skin-blue sidebar-mini">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="box box-primary">
                                <div class="box-header">
                                    <h3 class="box-title"> <?php echo $this->lang->line("Add Banner");?>  </h3>
                                </div><!-- /.box-header -->
                                <!-- form start -->
                                <form action="" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="col-md-6">
                                     <div class="form-group">
                                            <label class=""> <?php echo $this->lang->line("Banner Title");?>  : <span class="text-danger">*</span></label>
                                            <input type="text" name="slider_title" class="form-control" placeholder="Banner Title" value="<?php if(isset($_REQUEST["slider_title"])){echo $_REQUEST["slider_title"];} ?>"/>
                                        </div>
                                        </div>
                                   <div class="col-md-6">
                                     <div class="form-group">
                                            <label class=""> <?php echo $this->lang->line("Banner Url");?>  : </label>
                                            <input type="text" name="slider_url" class="form-control" placeholder="Banner Url/Link" value="<?php if(isset($_REQUEST["slider_url"])){echo $_REQUEST["slider_url"];} ?>"/>
                                        </div>
                                        </div>
                                    ...
                                    <div class="box-footer">
                                        <input type="submit" class="btn btn-primary" name="addslider" value="Add Banner" />
    ...
    <script type="text/javascript">
      ...
      //alert(id_name[1].search("add_Banner"));
      if(id_name[1].search("add_Banner")!='-1')
      {
