                        ...
                        <div class="col-xs-12">
                            ...
                            <div class="box box-primary">
                                <div class="box-header">
                                    <h3 class="box-title"> <?php echo "All Banner";?> </h3>    
                                ...
                                <div class="box-body">
                                    ...
                                    <table id="example1" class="table table-bordered table-striped">
                                        <thead>
                                            <tr>
                                                <th class="text-center"><?php echo $this->lang->line("Banner Title");?> </th>                                                 
                                                <th> <?php echo $this->lang->line("Banner Url");?> </th>
                                        ...
                                        <tbody>
                                           <?php foreach($allslider as $bus){ ?>
                                            <tr>
                                                ...
                                                <span class="label label-success"><a href="<?php echo site_url("admin/updatebannerdetails/".$bus->id."/0"); ?>" ><label style="color:white;"><?php echo $this->lang->line("Active");?></label><a></span><?php } else { ?><span class="label label-danger"><a href="<?php echo site_url("admin/updatebannerdetails/".$bus->id."/1"); ?>" ><label style="color:white;"><?php echo $this->lang->line("Deactive");?></label></a></span><?php } ?></td>
                                        
                                                <td class="text-center"><div class="btn-group">
                                                        <?php echo anchor('admin/edit_banner/'.$bus->id, '<i class="fa fa-edit"></i>', array("class"=>"btn btn-success")); ?>
                                                        <?php echo anchor('admin/delete_banner/'.$bus->id.'/'.$bus->slider_image, '<i class="fa fa-times"></i>', array("class"=>"btn btn-danger", "onclick"=>"return confirm('Are you sure delete?')")); ?>
