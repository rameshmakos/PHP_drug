  ...
  <body class="hold-transition skin-blue sidebar-mini">
                        ...
                        <div class="col-md-12">
                           ...
                           <div class="box box-primary">
                                ...
                                <div class="box-header">
                                    ...
                                    <a class="pull-right" href="<?php echo site_url("admin/addpage_app"); ?>"><?php echo $this->lang->line("ADD");?></a>                                        
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center"><div class="btn-group">
                                                       ...
                                                       <?php echo anchor('admin/deletepageapp/'.$allpage->id, '<i class="fa fa-times"></i>', array("class"=>"btn btn-danger", "onclick"=>"return confirm('Are you sure delete?')")); ?> 
    ...
    <script src="https://code.jquery.com/ui/1.11.4/jquery-ui.min.js"></script>
     ...
     // alert(id_name[1].search("categories"));
      if(id_name[1].search("allpageapp")!='-1')
      {
