                ...
                <!-- Content Header (Page header) -->
                 <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active"><?php echo "Add Driver";?></li>
                    </ol>
                </section>
                                ...
                                <form action="" method="post" enctype="multipart/form-data">
                                    <div class="box-body">
                                        <div class="form-group">
                                            <label><?php echo "Profile Photo";?> <span class="text-danger">*</span></label>
                                        ...
                                        <div class="form-group">
                                         ...
                                         <div class="form-group">
                                            <label class=""><?php echo "Last Name";?> <span class="text-danger">*</span></label> 
                                          ...
                                          <div class="form-group">
                                           ...
                                           <input type="email" name="email" class="form-control" placeholder="Email id" value="<?php echo set_value('email'); ?>" required/>
                                        </div>
                                        
                                        
                                        <div class="form-group">
                                            <label class=""> <?php echo "Password"; ?><span class="text-danger">*</span></label>
                                        <input placeholder="Password" required="required" type="password" value="" name="password" id="password" class="form-control">
                                        </div>
                                         <div class="form-group">
                                            <label class=""><?php echo $this->lang->line("Contact Number :");?> <span class="text-danger">*</span></label>
                                            <input type="number" name="phone" class="form-control" id="phone" value="<?php echo set_value('phone'); ?>" placeholder="Contact number" required maxlength="10"/>                                          
                                        </div>
                                        <div class="form-group">
                                            <label class=""><?php echo "Driver Address";?> <span class="text-danger">*</span></label>
                                             <input type="text" name="driver_address" id="shop_address" class="form-control" placeholder="Address"  required value="<?php echo set_value('driver_address'); ?>" />
                                             
                                        </div>
                                        
                                        <div class="form-group">
                                            <label class=""><?php echo "Transport Type";?> <span class="text-danger">*</span></label>
                                             <select name="transport_type" id="transport_type" class="form-control" placeholder="Address"  required />
                                        ...
                                        <input placeholder="MH13-AA-0000" type="text" value="" name="licence_plate" id="licence_plate" class="form-control">
                                       </div>
                                       
                                       <div class="form-group">
                                           <label class=""><?php echo "color";?> <span class="text-danger">*</span></label>
                                        <input placeholder="color" type="text" value="" name="color" id="color" class="form-control">
                                    </div>
                                     <!--- 
<div class="form-group">
                                        <label class=""><?php echo "Zip";?> <span class="text-danger">*</span></label>
                                        <input placeholder="123456" type="number" value="" name="zip" id="zip" class="form-control" min="100000" max="999999">
                                       </div>
                                        -->
<div class="form-group">
                                       ...
                                       <div class="form-group input_fields_wrap">
                                        <label class=""><?php echo "Zip";?> <span class="text-danger">*</span></label>
                                        <input placeholder="123456" type="number" value="" name="zip[]" id="zip" class="form-control" min="100000" max="999999" required>
                                       </div>
                                    </div><!-- /.box-body -->
                                    ...
                                    <div class="box-footer">
                                        <input type="submit" class="btn btn-primary" name="addcatg" value="Add Driver" />
  ...
  //  document.getElementById('shop_long').val="";
    ...
    <script>
     ...
     // alert(id_name[1].search("categories"));
      if(id_name[1].search("add_shop")!='-1')
      {
