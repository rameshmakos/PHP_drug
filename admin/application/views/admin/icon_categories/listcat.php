                        ...
                        <div class="col-xs-12">
                            ...
                            <div class="box box-primary">
                                <div class="box-header">
                                    ...
                                    <a class="pull-right" href="<?php echo site_url("admin/add_header_categories"); ?>"> <?php echo $this->lang->line("ADD");?></a>                                 
                                </div><!-- /.box-header -->
                                <div class="box-body table-responsive">
                                    <table id="example1" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                           <?php $counter = 0; foreach($allcat as $acat){ ?>
                                            <tr>
                                                ...
                                                <td class="text-center"><div class="btn-group">
                                                        <?php echo anchor('admin/edit_header_category/'.$acat->id, '<i class="fa fa-edit"></i>', array("class"=>"btn btn-success")); ?>
                                                        <?php echo anchor('admin/delete_header_categories/'.$acat->id, '<i class="fa fa-times"></i>', array("class"=>"btn btn-danger", "onclick"=>"return confirm('Are you sure delete?')")); ?>
