                                ...
                                <form action="" method="post" enctype="multipart/form-data">
                                    <div class="box-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="pincode" minlength="6" maxlength="6" class="form-control" placeholder="123456"/>
                                        </div>
                                         <div class="form-group" style="display:none;">
                                            <label class=""><?php echo $this->lang->line("Delivery Charge");?> : <span class="text-danger">*</span> </label>
                                            <input type="number" min="0" name="delivery" value="0" class="form-control" placeholder="00"/>
                                        </div>
                                    </div><!-- /.box-body -->
