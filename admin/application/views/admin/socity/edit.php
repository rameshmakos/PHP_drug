                                ...
                                <form action="" method="post" enctype="multipart/form-data">
                                    <div class="box-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="pincode" maxlength="6" minlength="6" value="<?php echo $socity->pincode; ?>" class="form-control" placeholder="123456"/>
                                        </div>
                                         <div class="form-group" style="display:none;">
                                            <label class=""><?php echo $this->lang->line("Delivery Charge");?> : <span class="text-danger">*</span> </label>
                                            <input type="number" min="0" name="delivery" value="<?php echo $socity->delivery_charge; ?>" class="form-control" placeholder="00"/>
                                        </div>
                                    </div><!-- /.box-body -->

                                    <div class="box-footer">
                                        <input type="submit" class="btn btn-primary" name="addcatg" value="Update Society" />
                                         <a href="<?php echo site_url("admin/socity"); ?>" class="btn btn-danger">Cancel</a>
