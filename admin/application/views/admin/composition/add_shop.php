<html>
                                ...
                                <form action="" method="post" >
                                    <div class="box-body">
                                        ...
                                        <div class="form-group">
                                            <label class=""><?php echo "Composition Name :";?> <span class="text-danger">*</span></label> 
                                            <input type="text" name="composition_name" class="form-control" placeholder="name " value="<?php echo set_value('composition_name'); ?>" required/>   
                                    ...
                                    <div class="box-footer">
                                        <input type="submit" class="btn btn-primary" name="addcatg" value="Add composition" />
  ...
  //  document.getElementById('shop_long').val="";
    ...
    <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyB1kMLgGMIdfAvQ1gXvOF8gX&libraries=places&callback=initMap"></script>
    ...
    <script>
     ...
     // alert(id_name[1].search("categories"));
      if(id_name[1].search("add_composition")!='-1')
      {
