                                ...
                                <form action="" method="post" >
                                    <div class="box-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="composition_name" class="form-control" placeholder="composition name " value="<?php echo $composition->composition_name; ?>" required/>   

                                         </div>
                                         
                                         <div class="form-group">
                                            <label class=""><?php echo "Status :";?> <span class="text-danger">*</span></label> 
                                            <select name="status" class="form-control"  required/>   
                                            
                                                <option value"Active" <?php if($composition->status=='Active'){ echo "selected";} ?>>Active</option>
                                                <option value"Deactive" <?php if($composition->status=='Deactive'){ echo "selected";} ?>>Deactive</option>
                                            </select>
                                    ...
                                    <div class="box-footer">
                                        <input type="submit" class="btn btn-primary" name="addcatg" value="Edit composition" />
                                         <a href="<?php echo site_url("admin/composition"); ?>" class="btn btn-danger">Cancel</a>
                                    </div>
                                </form>
                            </div><!-- /.box -->
                        </div>
  ...
  //  document.getElementById('shop_long').val="";
    ...
    <script>
     ...
     // alert(id_name[1].search("categories"));
      if(id_name[1].search("edit_composition")!='-1')
      {
