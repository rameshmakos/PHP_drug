...
<html>
  <head>
    ...
    <title>Admin | Edit Feature Slider</title>
  ...
  <body class="hold-transition skin-blue sidebar-mini">
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
              Featured Banner <?php echo $this->lang->line("");?> 
          </h1>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="box box-primary">
                                <div class="box-header">
                                    <h3 class="box-title">Edit Featured Banner <?php echo $this->lang->line("");?> </h3>
                                </div><!-- /.box-header -->
                                <!-- form start -->
                                <form action="" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="col-md-6">
                                     <div class="form-group">
                                            <label class="">Featured Banner Title<?php echo $this->lang->line("");?>  : <span class="text-danger">*</span></label>
                                            <input type="text" name="slider_title" class="form-control" placeholder="Featured Banner Title" value="<?php echo $slider->slider_title; ?>"/>
                                        </div>
                                        </div>
                                   <div class="col-md-6">
                                     <div class="form-group">
                                            <label class="">Featured Banner Url <?php echo $this->lang->line("");?>  : </label>
                                            <input type="text" name="slider_url" class="form-control" placeholder="Featured Banner Url/Link" value="<?php echo $slider->slider_url;?>" />
                                        </div>
                                  </div>
						 ...
						 <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <select class="text-input form-control" name="sub_cat">
                                                    ...
                                                    ?>
                                                     <option value="<?php echo $row->brand_id; ?>" <?php if($slider->brand_id==$row->brand_id){echo "selected";}?>><?php echo $row->name; ?></option>
   ...
   <script type="text/javascript">
     ...
     // alert(id_name[1].search("categories"));
      if(id_name[1].search("edit_feature_banner")!='-1')
      {
