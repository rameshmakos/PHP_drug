...
<html>
  <head>
    ...
    <title>Admin | Add Feature Banner</title>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="box box-primary">
                                <div class="box-header">
                                    <h3 class="box-title"> <?php echo $this->lang->line("Add Featured Banner");?>  </h3>
                                </div><!-- /.box-header -->
                                <!-- form start -->
                                <form action="" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="col-md-6">
                                     <div class="form-group">
                                            <label class=""> <?php echo $this->lang->line("Featured Banner Title");?>  : <span class="text-danger">*</span></label>
                                            <input type="text" name="slider_title" class="form-control" placeholder="Featured Banner Title" value="<?php if(isset($_REQUEST["slider_title"])){echo $_REQUEST["slider_title"];} ?>"/>
                                        </div>
                                        </div>
                                   <div class="col-md-6">
                                     <div class="form-group">
                                            <label class=""> <?php echo $this->lang->line("Featured Banner Url");?>  : </label>
                                            <input type="text" name="slider_url" class="form-control" placeholder="Featured Banner Url/Link" value="<?php if(isset($_REQUEST["slider_url"])){echo $_REQUEST["slider_url"];} ?>"/>
                                        </div>
                                        </div>
...
<div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <select class="text-input form-control" name="sub_cat">
                                                    <option> <?php echo "Select Brand"; ?></option>
                                                                  <?php  
                                                    $q = $this->db->query("SELECT * FROM `brand` WHERE STATUS='Active'");
                                                    $rows = $q->result();
                                    ...
                                    <div class="box-footer">
                                        <input type="submit" class="btn btn-primary" name="addslider" value="Add Feature Banner" />
                                        <a href="<?php echo site_url("admin/feature_banner"); ?>" class="btn btn-danger">Cancel</a>
                                    </div>
                                </form>
                            </div><!-- /.box -->
                        </div>
    ...
    <script type="text/javascript">
     ...
     // alert(id_name[1].search("categories"));
      if(id_name[1].search("add_feature_Banner")!='-1')
      {
