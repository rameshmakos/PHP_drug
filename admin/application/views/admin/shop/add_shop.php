      ...
      <div class="content-wrapper">
                ...
                <!-- Content Header (Page header) -->
                 <section class="content-header">
                    <h1>
                        <?php echo $this->lang->line("Add Shop");?>
                                ...
                                <form action="" method="post" enctype="multipart/form-data">
                                    <div class="box-body">
                                        <div class="form-group">
                                            <label><?php echo "Shop Logo";?> <span class="text-danger">*</span></label>
                                            <input type="file" name="logo" required/>
                                        </div>
                                        
                                        <div class="form-group">
                                            <label class=""><?php echo $this->lang->line("Shop Title :");?> <span class="text-danger">*</span></label> 
                                            <input type="text" name="shop_title" class="form-control" placeholder="Shop Title" value="<?php echo set_value('shop_title'); ?>" required/>   

                                         </div>
                                          <div class="form-group">
                                            <label class=""> <?php echo $this->lang->line("Email Id :"); ?><span class="text-danger">*</span></label>
                                           <input type="email" name="shop_email" class="form-control" placeholder="Email id" value="<?php echo set_value('shop_email'); ?>" required/>
                                        </div>
                                         <div class="form-group">
                                            <label class=""><?php echo $this->lang->line("Contact Number :");?> <span class="text-danger">*</span></label>
                                            <input type="text" name="contact_number" class="form-control" id="contact_number" value="<?php echo set_value('contact_number'); ?>" placeholder="Contact number" required maxlength="10"/>                                          
                                        </div>
                                        <div class="form-group">
                                            <label class=""><?php echo $this->lang->line("Shop Address :");?> <span class="text-danger">*</span></label>
                                             <input type="text" name="shop_address" id="shop_address" class="form-control" placeholder="Address" onkeyup="initMap();" required value="<?php echo set_value('shop_address'); ?>" />
                                             <div id="map" style="display:none;"></div>
                                             <input type="hidden" name="shop_lat" id="shop_lat" value="<?php echo set_value('shop_lat'); ?>"/>
                                             <input type="hidden" name="shop_long" id="shop_long" value="<?php echo set_value('shop_long'); ?>"/>       
                                        </div>
                                    ...
                                    <div class="box-footer">
                                        <input type="submit" class="btn btn-primary" name="addcatg" value="Add Shop" />
