  ...
  <body class="hold-transition skin-blue sidebar-mini">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="box box-primary">
                                ...
                                <div class="box-header">
                                    ...
                                    <h3 class="box-title"><?php echo $this->lang->line("First Time Slot");?></h3>
							...
							<div class="row">
						Delivery Date: <input type="date" name="delivery_date" class="form-control" required >
							</div>
                                                    <div class="row">
                                                    ...
                                                    <div class="box-header">
                                                        ...
                                                        <h3 class="box-title"><?php echo $this->lang->line("Second Time Slot");?></h3>

                                                    </div> 
                                                    <div class="row">

                                                    <label class="col-md-6"><?php echo $this->lang->line("Opening Hour");?></label>

                                                    <label class="col-md-6"><?php echo $this->lang->line("Closing Hour");?></label>

                                                    <div class="col-md-6">

                                                        <input type="text" name="second_slot_opening_time" id="morning_from" value="<?php echo (!empty($schedule) &&  $schedule->second_slot_opening_time != "" ) ?  date("h:i A",strtotime( $schedule->second_slot_opening_time )) :  ""; ?>" class="form-control input-sm" placeholder="HH:MM PP"  />

                                                    </div>

                                                    <div class="col-md-6">

                                                      <input type="text" name="second_slot_closing_time" id="morning_to" value="<?php echo (!empty($schedule) && $schedule->second_slot_closing_time != "") ?  date("h:i A",strtotime( $schedule->second_slot_closing_time )) :  ""; ?>" class="form-control input-sm" placeholder="HH:MM PP"  />
    ...
    <script type="text/javascript">
     ...
     // alert(id_name[1].search("categories"));
      if(id_name[1].search("time_slot")!='-1')
      {
        if($(".set_active_class").hasClass("active"))
        {
          $(".set_active_class").removeClass("active");
          $("#delivery_schedule_hours").addClass("active");  
        }
        else{
          $("#delivery_schedule_hours").addClass("active");
        }
