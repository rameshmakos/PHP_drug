  ...
  <body class="hold-transition skin-blue sidebar-mini">
                ...
                <!-- Content Header (Page header) -->
                 ...
                 <section class="content-header">
                    ...
                    <h1>
                        ...
                        <small><?php echo $this->lang->line("Closing Hours");?></small>
                          ...
                          <?php  if(isset($error)){ echo $error; }
                            ...
                            <div class="box box-primary">
                                ...
                                <div class="box-header">
                                    ...
                                    <h3 class="box-title"><?php echo $this->lang->line("Closing Hours");?></h3>
                                ...
                                <form action="" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                                    ...
                                                    <label class="col-md-4"><?php echo $this->lang->line("Start Time");?></label>

                                                    <label class="col-md-4"><?php echo $this->lang->line("End Time");?></label>

                                                    

                                                    <div class="col-md-4">

                                                        <input type="date" name="date" id="datepicker"  class="form-control input-sm" placeholder="yyyy-mm-dd"  />

                                                    </div>

                                                    <div class="col-md-4">

                                                        <input type="time" name="opening_time" id="morning_from"  class="form-control input-sm" placeholder="HH:MM PP"  />

                                                    </div>

                                                    <div class="col-md-4">

                                                      <input type="time" name="closing_time" id="morning_to"  class="form-control input-sm" placeholder="HH:MM PP"  />
                                    ...
                                    <table id="example1" class="table table-bordered table-striped">
                                        ...
                                        <thead>
                                            ...
                                            <tr>
                                                ...
                                                <th><?php echo $this->lang->line("Start Time - End Time");?></th>
    ...
    <script>
     ...
     // alert(id_name[1].search("categories"));
      if(id_name[1].search("closing_hours")!='-1')
      {
