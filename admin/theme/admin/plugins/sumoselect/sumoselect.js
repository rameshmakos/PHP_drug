        ...
        var ret = this.each(function () {
            ...
            this.sumo = {
                ...
                createElems: function () {
                    var O = this;
                    O.E.wrap('<div class="SumoSelect" tabindex="0" style="width:550px;">');
                    O.select = O.E.parent();
                    O.caption = $('<span>');
...
window.testSelAll = $('.testSelAll').SumoSelect({csvDispCount: 3, selectAll:true, search: true, searchText:'Enter here.', okCancelInMulti:true });    
