                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="box box-primary">
                                <form action="<?php echo site_url("CSV/upload_file"); ?>" method="post" enctype="multipart/form-data">
                                    <div class="box-body">
                                        
                                        
                                        <div class="form-group">
                                            <label class=""><?php echo "file :";?> <span class="text-danger">*</span></label> 
                                    ...
                                    <div class="box-footer">
                                        <input type="submit" class="btn btn-primary" name="addcatg" value="upload CSV" />
